...
- **정정(같은 날, 후속 조사):** 결론 3·8단계의 "계수 경계 오탐"은 [blocky·밀림 조사](2026-07-02-blocky-shift-dc-offset.md) 4단계에서 **수정됐다** — plain e0 완주 40건 전원이 물리 초과 DC 드리프트 보유로 경계는 정탐이며, 수락 실패의 본질은 연속 손상 간격 < 450. 이 문서의 나머지 결론(1·2·4·5·6)은 유효하다. (스냅샷 본문은 원문 유지, 이 줄만 항행용 추가.)
