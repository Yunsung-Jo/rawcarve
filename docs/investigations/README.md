...
| 2026-07-02 | [잔존 회색·SKIP의 도구 측 원인 3종](2026-07-02-recovery-tool-blindspots.md) | 822건 전수 재질의 → SKIP 122 전부 헤더 손상(DHT 소실 66, 다수파=Annex-K 이식으로 복원 실증), 소형 이미지 수락 임계 잠금 196건(비례 임계로 4/5 복구 실증), 계수 경계 quant 미보정. "데이터 한계" 결론의 과대적용 정정. 발견만 기록(코드 변경 없음) |
